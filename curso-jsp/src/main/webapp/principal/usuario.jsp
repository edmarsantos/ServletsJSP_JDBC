																...
																<div class="input-group-prepend">
																	<c:if
																		...
																		<a
																			...
																			<img alt="Image User" id="fotoembase64"
																			src="${modolLogin.fotouser}" with="40px"
																			height="50px">
																		</a>
																	</c:if>
																	<c:if
																		test="${modolLogin.fotouser == '' || modolLogin.fotouser == null}">
																		<img alt="Image User" id="fotoembase64"
																			src="assets/images/user.png" with="40px"
																			height="50px">
																	</c:if>
				...
				$("#numero").keypress(function (event) {
					...
					function buscarUserPageAjax(url) {
						...
						$.ajax({
								...
								.fail(
										function(xhr, status, errorThorwn) {
					...
					function buscarUsuario() {
						...
						if (nomeBusca != null && nomeBusca != ''
								&& nomeBusca.trim() != '') { /* validando q tem valor para buscar*/
